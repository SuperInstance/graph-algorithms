//! Network analysis: topology, connectivity, influence propagation.
...
/// Identify the most influential vertices using betweenness centrality (approximate).
/// Returns a sorted vector of (vertex_index, centrality_score) in descending order.
